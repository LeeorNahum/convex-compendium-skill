...
_Source: <https://github.com/get-convex/agent-skills/tree/ec1e6baae7d86c7843c22938c75979c016f5c6e9/skills/convex-performance-audit>_

> Frozen on 2026-08-25 at upstream commit ec1e6baae7d86c7843c22938c75979c016f5c6e9, the last revision that published this skill. Upstream replaced it with the generated `convex-optimize` and `convex-advisor` procedure, which depends on convex-agents hub tooling and drops the material bundled here. The source manifest records this freeze.
...
<a id="reference-function-budget"></a>

## Reference: function-budget

<a id="reference-function-budget-function-budget"></a>
### Function Budget
...
<a id="reference-function-budget-core-principle"></a>
#### Core Principle
...
<a id="reference-function-budget-limits-to-know"></a>
#### Limits to Know
...
<a id="reference-function-budget-symptoms"></a>
#### Symptoms
...
<a id="reference-function-budget-common-causes"></a>
#### Common Causes

<a id="reference-function-budget-unbounded-collection"></a>
...
<a id="reference-function-budget-large-document-reads-on-hot-paths"></a>
...
<a id="reference-function-budget-mutation-doing-too-much-work"></a>
...
<a id="reference-function-budget-returning-too-much-data-to-the-client"></a>
##### Returning too much data to the client

A query returning full documents when the client only needs a few fields.

<a id="reference-function-budget-fix-order"></a>
#### Fix Order

<a id="reference-function-budget-1-bound-your-reads"></a>
##### 1. Bound your reads
...
<a id="reference-function-budget-2-read-smaller-shapes"></a>
...
<a id="reference-function-budget-3-break-large-mutations-into-batches"></a>
...
<a id="reference-function-budget-4-move-heavy-work-to-actions"></a>
...
<a id="reference-function-budget-5-trim-return-values"></a>
...
<a id="reference-function-budget-6-replace-ctxrunquery-and-ctxrunmutation-with-helper-functions"></a>
...
<a id="reference-function-budget-7-avoid-unnecessary-runaction-calls"></a>
...
<a id="reference-function-budget-verification"></a>
#### Verification
...
<a id="reference-hot-path-rules"></a>

## Reference: hot-path-rules

<a id="reference-hot-path-rules-hot-path-rules"></a>
### Hot Path Rules
...
<a id="reference-hot-path-rules-contents"></a>
#### Contents
...
<a id="reference-hot-path-rules-core-principle"></a>
#### Core Principle
...
<a id="reference-hot-path-rules-consistency-rule"></a>
#### Consistency Rule
...
<a id="reference-hot-path-rules-1-push-filters-to-storage"></a>
...
<a id="reference-hot-path-rules-migration-rule-for-indexes"></a>
...
<a id="reference-hot-path-rules-check-for-redundant-indexes"></a>
...
<a id="reference-hot-path-rules-2-minimize-data-sources"></a>
...
<a id="reference-hot-path-rules-when-to-denormalize"></a>
##### When to denormalize
...
<a id="reference-hot-path-rules-fallback-rule"></a>
##### Fallback rule
...
<a id="reference-hot-path-rules-no-denormalized-copy-yet"></a>
...
<a id="reference-hot-path-rules-3-minimize-row-size"></a>
#### 3. Minimize Row Size
...
<a id="reference-hot-path-rules-4-isolate-frequently-updated-fields"></a>
...
<a id="reference-hot-path-rules-5-match-consistency-to-read-patterns"></a>
#### 5. Match Consistency To Read Patterns

Choose read strategy based on traffic shape.

<a id="reference-hot-path-rules-high-read-low-write"></a>
##### High-read, low-write
...
<a id="reference-hot-path-rules-high-read-high-write"></a>
##### High-read, high-write
...
<a id="reference-hot-path-rules-convex-specific-notes"></a>
#### Convex-Specific Notes

<a id="reference-hot-path-rules-reactive-queries"></a>
##### Reactive queries
...
<a id="reference-hot-path-rules-point-in-time-reads"></a>
##### Point-in-time reads
...
<a id="reference-hot-path-rules-triggers-and-fan-out"></a>
...
<a id="reference-hot-path-rules-aggregates"></a>
##### Aggregates
...
<a id="reference-hot-path-rules-backfills"></a>
##### Backfills
...
<a id="reference-hot-path-rules-verification"></a>
#### Verification
...
<a id="reference-occ-conflicts"></a>

## Reference: occ-conflicts

<a id="reference-occ-conflicts-occ-conflict-resolution"></a>
...
<a id="reference-occ-conflicts-core-principle"></a>
#### Core Principle
...
<a id="reference-occ-conflicts-symptoms"></a>
#### Symptoms
...
<a id="reference-occ-conflicts-common-causes"></a>
#### Common Causes

<a id="reference-occ-conflicts-hot-documents"></a>
##### Hot documents
...
<a id="reference-occ-conflicts-broad-read-sets-causing-false-conflicts"></a>
...
<a id="reference-occ-conflicts-fan-out-from-triggers-or-cascading-writes"></a>
...
<a id="reference-occ-conflicts-write-then-read-chains"></a>
...
<a id="reference-occ-conflicts-fix-order"></a>
#### Fix Order

<a id="reference-occ-conflicts-1-reduce-read-set-size"></a>
...
<a id="reference-occ-conflicts-2-split-hot-documents"></a>
...
<a id="reference-occ-conflicts-3-move-non-critical-work-to-scheduled-functions"></a>
...
<a id="reference-occ-conflicts-4-combine-competing-writes"></a>
...
<a id="reference-occ-conflicts-related-invalidation-scope"></a>
...
<a id="reference-occ-conflicts-verification"></a>
#### Verification
...
<a id="reference-subscription-cost"></a>

## Reference: subscription-cost

<a id="reference-subscription-cost-subscription-cost"></a>
### Subscription Cost
...
<a id="reference-subscription-cost-core-principle"></a>
#### Core Principle
...
<a id="reference-subscription-cost-symptoms"></a>
#### Symptoms
...
<a id="reference-subscription-cost-common-causes"></a>
#### Common Causes

<a id="reference-subscription-cost-reactive-queries-on-low-freshness-flows"></a>
...
<a id="reference-subscription-cost-overly-broad-queries"></a>
...
<a id="reference-subscription-cost-too-many-subscriptions-per-page"></a>
...
<a id="reference-subscription-cost-paginated-queries-keeping-all-pages-live"></a>
...
<a id="reference-subscription-cost-frequently-updated-fields-on-widely-read-documents"></a>
...
<a id="reference-subscription-cost-fix-order"></a>
#### Fix Order

<a id="reference-subscription-cost-1-use-point-in-time-reads-when-live-updates-are-not-valuable"></a>
...
<a id="reference-subscription-cost-2-batch-related-data-into-fewer-queries"></a>
...
<a id="reference-subscription-cost-3-use-skip-to-avoid-unnecessary-subscriptions"></a>
...
<a id="reference-subscription-cost-4-isolate-frequently-updated-fields-into-separate-documents"></a>
...
<a id="reference-subscription-cost-5-use-the-aggregate-component-for-counts-and-sums"></a>
...
<a id="reference-subscription-cost-6-narrow-query-read-sets"></a>
...
<a id="reference-subscription-cost-7-remove-datenow-from-queries"></a>
...
<a id="reference-subscription-cost-8-consider-pagination-strategy"></a>
...
<a id="reference-subscription-cost-9-separate-backend-cost-from-ui-churn"></a>
...
<a id="reference-subscription-cost-verification"></a>
#### Verification
