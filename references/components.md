...
_Source: <https://github.com/get-convex/agent-skills/tree/main/skills/convex-create-component>_
...
<a id="reference-advanced-patterns"></a>

## Reference: advanced-patterns

<a id="reference-advanced-patterns-advanced-component-patterns"></a>
### Advanced Component Patterns

Additional patterns for Convex components that go beyond the basics covered in
the main skill file.

<a id="reference-advanced-patterns-function-handles-for-callbacks"></a>
...
<a id="reference-advanced-patterns-deriving-validators-from-schema"></a>
...
<a id="reference-advanced-patterns-static-configuration-with-a-globals-table"></a>
...
<a id="reference-advanced-patterns-class-based-client-wrappers"></a>
...
<a id="reference-hybrid-components"></a>

## Reference: hybrid-components

<a id="reference-hybrid-components-hybrid-convex-components"></a>
### Hybrid Convex Components

Read this file only when the user explicitly wants a hybrid setup.

<a id="reference-hybrid-components-what-this-means"></a>
#### What This Means
...
<a id="reference-hybrid-components-default-advice"></a>
#### Default Advice
...
<a id="reference-hybrid-components-risks"></a>
#### Risks
...
<a id="reference-hybrid-components-checklist"></a>
#### Checklist
...
<a id="reference-local-components"></a>

## Reference: local-components

<a id="reference-local-components-local-convex-components"></a>
...
<a id="reference-local-components-when-to-choose-this"></a>
#### When to Choose This
...
<a id="reference-local-components-default-layout"></a>
#### Default Layout
...
<a id="reference-local-components-workflow-notes"></a>
#### Workflow Notes
...
<a id="reference-local-components-checklist"></a>
#### Checklist
...
<a id="reference-packaged-components"></a>

## Reference: packaged-components

<a id="reference-packaged-components-packaged-convex-components"></a>
### Packaged Convex Components

Read this file when the user wants a reusable npm package or a component shared
across multiple apps.

<a id="reference-packaged-components-when-to-choose-this"></a>
#### When to Choose This
...
<a id="reference-packaged-components-default-approach"></a>
#### Default Approach
...
<a id="reference-packaged-components-build-flow"></a>
#### Build Flow
...
<a id="reference-packaged-components-package-exports"></a>
#### Package Exports
...
<a id="reference-packaged-components-testing"></a>
#### Testing
...
<a id="reference-packaged-components-checklist"></a>
#### Checklist
